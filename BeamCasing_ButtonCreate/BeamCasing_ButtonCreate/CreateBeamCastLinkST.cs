...
namespace BeamCasing_ButtonCreate
{
    ...
    public class CreateBeamCastLinkST : IExternalCommand
    {
#if RELEASE2019
                    ...
                    using (Transaction trans = new Transaction(doc))
                    {
                        ...
                        if (null != solid)
                        {
                            ...
                            for (int i = 0; i < intersectCount; i++)
                            {
                                ...
                                FamilySymbol CastSymbol2 = new BeamCastST().findCastSymbol(doc, RC_Cast, linkedPipe);
                                ...
                                Line beamCurve = beamLocate.Curve as Line;
                                XYZ beamDir = beamCurve.Direction.Normalize();
